...
// Contact links - update these with actual links
const CONTACT_LINKS = {
  viber: 'viber://chat?number=%2B639123456789', // Replace with actual Viber number
  whatsapp: 'https://wa.me/639123456789', // Replace with actual WhatsApp number
  messenger: 'https://m.me/ARCarRentals', // Replace with actual Messenger page
};
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        >
          ...
          <div className="w-12 h-12 rounded-full bg-[#7360F2] hover:bg-[#5e4dd1] shadow-lg flex items-center justify-center transition-all hover:scale-110">
        ...
        >
          ...
          <div className="w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#1fb855] shadow-lg flex items-center justify-center transition-all hover:scale-110">
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
        ...
        >
          ...
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00B2FF] to-[#006AFF] hover:from-[#00a0e6] hover:to-[#005ce6] shadow-lg flex items-center justify-center transition-all hover:scale-110">
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
